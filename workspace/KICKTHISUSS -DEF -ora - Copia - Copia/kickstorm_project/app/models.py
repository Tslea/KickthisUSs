...
class Project(db.Model):
    ...
    creator_equity = db.Column(db.Float, nullable=True, default=10.0)  # Default 10% for creator, nullable for scientific
    platform_fee = db.Column(db.Float, nullable=False, default=5.0)  # Default 5% for KickthisUSs platform
