...
def init_sentry():
    ...
    if sentry_dsn:
        sentry_sdk.init(
            ...
            release=os.environ.get('APP_VERSION', 'mvp-1.0.0'),
            # Send default PII (email, username) - set to False for strict privacy
...
def create_app(config_class=Config):
    ...
    # ============================================
    # TERMINOLOGY CONTEXT PROCESSOR
    # ============================================
    from .terminology import inject_terminology
